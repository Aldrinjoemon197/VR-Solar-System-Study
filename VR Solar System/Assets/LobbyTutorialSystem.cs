...
public class LobbyTutorialSystem : MonoBehaviour
{
    ...
    void SetupLobby()
    {
        ...
        CreateTutorialOrb(
            ...
            "CONTROLS",
            "Left stick moves. Right stick turns. A down. B up.",
            "Grip changes ship mode. Menu starts wormhole."
        );
        ...
        CreateTutorialOrb(
            ...
            "TOOLS",
            "Right trigger shoots. Laser opens tablets. Planets can split.",
            "Hold X to scan layers."
        );
        ...
        CreateTutorialOrb(
            ...
            "MODES",
            "Y opens Analysis Mode. Compare planets. Measure distance.",
            "Gas charts and moons are inside."
        );
        ...
        CreateTutorialAsteroid(
            ...
            0.55f,
            "AVAILABLE MODES",
            "Ship mode flies the craft. Astronaut mode moves freely. Analysis studies planets.",
            "Shoot planets to learn more."
        );
        ...
        CreateTutorialAsteroid(
            ...
            0.52f,
            "BUTTON GUIDE",
            "Left stick moves. A moves down. B moves up. Y opens analysis.",
            "Menu opens wormhole. Right trigger shoots."
        );
...
public class LobbyShootInfoTarget : MonoBehaviour
{
    ...
    void BuildTablet()
    {
        ...
        CreateText("Tablet Body", WrapText(body, 48, 4), new Vector3(0f, 0.095f, -0.045f), 0.030f, 38, TextAnchor.MiddleCenter);
        CreateText("Tablet Footer", WrapText(footer, 48, 2), new Vector3(0f, -0.570f, -0.045f), 0.027f, 34, TextAnchor.MiddleCenter);
