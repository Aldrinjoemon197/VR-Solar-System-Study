...
public class LeftHandLayerHologramProjector : MonoBehaviour
{
    ...
    )
    {
        ...
        while (current != null)
        {
            ...
            if (planetName == "SUN")
            {
                ...
                {
                    layerName = "CORONA";
                    layerDescription = "Outer hot plasma";
                    layerColor = new Color(1.00f, 0.95f, 0.45f);
                    return true;
                }

                if (n.Contains("photosphere") || n.Contains("outersurface"))
                {
                    layerName = "PHOTOSPHERE";
                    layerDescription = "Visible surface";
                    layerColor = new Color(1.00f, 0.72f, 0.08f);
                    return true;
                }

                if (n.Contains("convective"))
                {
                    layerName = "CONVECTIVE ZONE";
                    layerDescription = "Rising hot plasma";
                    layerColor = new Color(1.00f, 0.42f, 0.05f);
                    return true;
                }

                if (n.Contains("radiative"))
                {
                    layerName = "RADIATIVE ZONE";
                    layerDescription = "Light diffuses outward";
                    layerColor = new Color(1.00f, 0.18f, 0.05f);
                    return true;
                }
                ...
                {
                    layerName = "CORE";
                    layerDescription = "Fusion power source";
                    layerColor = new Color(1.00f, 0.95f, 0.70f);
                    return true;
                }
            }
    ...
    void BuildProjectorAndHologram()
    {
        ...
        float descriptionY = -0.060f;
        float statusY = -halfHeight + 0.024f;
    ...
    void ShowPanel(string planetName, string layerName, string description, string status, Color color)
    {
        ...
        descriptionText.text = WrapText(description, 28, 2);
        statusText.text = "";
